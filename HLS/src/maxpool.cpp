...
MXP_1_out_struct MAXPOOL_1( acc_type (&image_in)[MXP_1_IMAGE_IN_ZISE])
{
    ...
    M1_ch:for(int channel = 0; channel<MXP_1_I_IN_CHANNELS_ZISE; channel++)
    {
        M1_y:for(int row = 0; row<MXP_1_I_IN_ROWS_ZISE; row=row+2)
        {
            M1_x:for(int column = 0; column<MXP_1_I_IN_COLUMNS_ZISE; column=column+2)
            {
                ...
                M1_mxy:for(int ty=0 ; ty < row_window; ty++) 
                    M1_mxx:for(int tx=0 ; tx < column_window; tx++)
                    {   
...
MXP_2_out_struct MAXPOOL_2(acc_type (&image_in)[MXP_2_IMAGE_IN_ZISE])
{
    ...
    M2_ch:for(int channel = 0; channel<MXP_2_I_IN_CHANNELS_ZISE; channel++)
    {
        M2_y:for(int row = 0; row<MXP_2_I_IN_ROWS_ZISE; row=row+2)
        {
            M2_x:for(int column = 0; column<MXP_2_I_IN_COLUMNS_ZISE; column=column+2)
            {
                acc_type temp_max_val = 0 ;
                ...
                M2_mxy:for(int ty=0 ; ty < row_window; ty++) 
                    M2_mxx:for(int tx=0 ; tx < column_window; tx++)
                    {   
...
MXP_3_out_struct MAXPOOL_3( acc_type (&image_in)[MXP_3_IMAGE_IN_ZISE])
{
    ...
    M3_ch:for(int channel = 0; channel<MXP_3_I_IN_CHANNELS_ZISE; channel++)
    {
        M3_y:for(int row = 0; row<MXP_3_I_IN_ROWS_ZISE; row=row+2)
        {
            M3_x:for(int column = 0; column<MXP_3_I_IN_COLUMNS_ZISE; column=column+2)
            {
                acc_type temp_max_val = 0 ;
                ...
                M3_mxy:for(int ty=0 ; ty < row_window; ty++) 
                    M3_mxx:for(int tx=0 ; tx < column_window; tx++)
                    {   
