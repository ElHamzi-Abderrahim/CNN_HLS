...
MXP_1_out_struct MAXPOOL_1( double (&image_in)[MXP_1_IMAGE_IN_ZISE]) ;
MXP_2_out_struct MAXPOOL_2( double (&image_in)[MXP_2_IMAGE_IN_ZISE]) ;
MXP_3_out_struct MAXPOOL_3( double (&image_in)[MXP_3_IMAGE_IN_ZISE]) ;
